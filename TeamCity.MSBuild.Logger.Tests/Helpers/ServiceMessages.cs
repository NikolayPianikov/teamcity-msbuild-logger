...
internal static class ServiceMessages
{
    ...
    public static IEnumerable<string?> FilterTeamCityServiceMessages(IEnumerable<string?> lines)
    {
    ...
    public static int GetNumberServiceMessage(IEnumerable<string> lines)
    {
        if (lines == null) throw new ArgumentNullException(nameof(lines));
        return GetNumberServiceMessage(string.Join("\n", lines));
    }

    public static void ResultShouldContainCorrectStructureAndSequence(IEnumerable<string> lines)
    {
        ResultShouldContainCorrectStructureAndSequence(string.Join("\n", lines));
    }

    private static int GetNumberServiceMessage(string text)
    {
    ...
    private static void ResultShouldContainCorrectStructureAndSequence(string text)
    {
        if (text == null) throw new ArgumentNullException(nameof(text));
