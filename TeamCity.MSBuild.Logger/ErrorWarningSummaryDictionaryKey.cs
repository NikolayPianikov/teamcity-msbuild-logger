...
internal class ErrorWarningSummaryDictionaryKey
{
    ...
    {
        if (obj is not ErrorWarningSummaryDictionaryKey summaryDictionaryKey || !ComparerContextNodeId.Shared.Equals(EntryPointContext, summaryDictionaryKey.EntryPointContext))
        {
            return false;
        }
