...
internal class LoggerContext: ILoggerContext
{
        ...
        IBuildEventManager buildEventManager)
    {
        ...
        Parameters = new Parameters(environment);
    ...
    public IList<BuildErrorEventArgs>? ErrorList { get; private set; }
    ...
    public ProjectFullKey LastProjectFullKey { get; set; } = new(0, 0);
    ...
    {
        ProjectStartedEventMinimumFields? eventMinimumFields = default;
        if (e != null)
        {
